...
function fizzBuzz(){
    for(int i = 0; i < 101; i++){
      ...
      ", "&&");
      Challenge challenge10 = new Challenge(@"...Whiteboard is empty... I couldn't even have DREAMed of this scenario. Or could I have?", "potato");
